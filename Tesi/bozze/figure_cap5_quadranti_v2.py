...
def figura(K):
    ...
    ax.set_title('B. Il divario tiene in quattro fasce su cinque\n'
                 'si inverte dove Wikipedia ha dieci parole', fontsize=10)
    ax.axvspan(-0.45, 0.45, color='grey', alpha=.13, zorder=0)
    ax.annotate('n = 10', (0, float(t.loc['15-25', 'wikipedia'])),
                xytext=(12, 6), textcoords='offset points', fontsize=8,
                color='#0072B2',
                arrowprops=dict(arrowstyle='-', color='#0072B2', lw=.8))
